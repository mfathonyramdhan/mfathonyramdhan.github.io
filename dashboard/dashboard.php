                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.php">
                            <img src="images/icon/logo.png" alt="CoolAdmin" class="shake-slow shake-hover">
                        </a>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li>
                            <a href="dashboard.php">
                                <i class="fas fa-th-large"></i>postingan</a>
                        </li>
                        <li>
                            <a href="chart.php">
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="active">
                            <a class="js-arrow" href="dashboard.php">
                                <i class="fas fa-th-large"></i>Postingan
                            </a>
                        </li>
                        <li>
                            <a href="chart.php">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">     
                                            ...
                                            <!-- <a class="js-acc-btn" href="#">faisal affan</a> -->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row m-b-25">
                                    <div class="col-sm-4">
                                        <h2 class="title-1 m-b-25">Data Berita</h2>
                                    </div>
